...
public class AppStoreVersionExperimentsResponse {
  ...
  public AppStoreVersionExperimentsResponse data(@jakarta.annotation.Nonnull List<AppStoreVersionExperiment> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<AppStoreVersionExperiment> data) {
    this.data = data;
  }


  public AppStoreVersionExperimentsResponse included(@jakarta.annotation.Nullable List<AppStoreVersionExperimentsResponseIncludedInner> included) {
  ...
  public AppStoreVersionExperimentsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppStoreVersionExperimentsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
