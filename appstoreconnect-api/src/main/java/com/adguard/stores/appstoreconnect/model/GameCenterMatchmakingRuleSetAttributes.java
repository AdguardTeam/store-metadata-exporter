...
public class GameCenterMatchmakingRuleSetAttributes {
  ...
  public GameCenterMatchmakingRuleSetAttributes referenceName(@jakarta.annotation.Nullable String referenceName) {
  ...
  public GameCenterMatchmakingRuleSetAttributes ruleLanguageVersion(@jakarta.annotation.Nullable Integer ruleLanguageVersion) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RULE_LANGUAGE_VERSION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_RULE_LANGUAGE_VERSION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRuleLanguageVersion(@jakarta.annotation.Nullable Integer ruleLanguageVersion) {
    this.ruleLanguageVersion = ruleLanguageVersion;
  }


  public GameCenterMatchmakingRuleSetAttributes minPlayers(@jakarta.annotation.Nullable Integer minPlayers) {
  ...
  public GameCenterMatchmakingRuleSetAttributes maxPlayers(@jakarta.annotation.Nullable Integer maxPlayers) {
