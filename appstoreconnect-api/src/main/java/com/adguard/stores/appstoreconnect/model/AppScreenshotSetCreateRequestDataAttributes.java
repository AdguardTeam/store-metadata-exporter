...
import com.adguard.stores.appstoreconnect.model.ScreenshotDisplayType;
...
public class AppScreenshotSetCreateRequestDataAttributes {
  ...
  public AppScreenshotSetCreateRequestDataAttributes screenshotDisplayType(@jakarta.annotation.Nonnull ScreenshotDisplayType screenshotDisplayType) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_SCREENSHOT_DISPLAY_TYPE, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_SCREENSHOT_DISPLAY_TYPE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setScreenshotDisplayType(@jakarta.annotation.Nonnull ScreenshotDisplayType screenshotDisplayType) {
    this.screenshotDisplayType = screenshotDisplayType;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `screenshotDisplayType` to the URL query string
    if (getScreenshotDisplayType() != null) {
      joiner.add(String.format(Locale.ROOT, "%sscreenshotDisplayType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getScreenshotDisplayType()))));
    }
