...
import com.adguard.stores.appstoreconnect.model.AgeRatingDeclarationUpdateRequestDataAttributes;
...
public class AgeRatingDeclarationUpdateRequestData {
  ...
  public enum TypeEnum {
    AGE_RATING_DECLARATIONS(String.valueOf("ageRatingDeclarations"));
  ...
  private AgeRatingDeclarationUpdateRequestDataAttributes attributes;

  public AgeRatingDeclarationUpdateRequestData() { 
  }

  public AgeRatingDeclarationUpdateRequestData type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AgeRatingDeclarationUpdateRequestData id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public AgeRatingDeclarationUpdateRequestData attributes(@jakarta.annotation.Nullable AgeRatingDeclarationUpdateRequestDataAttributes attributes) {
  ...
  public AgeRatingDeclarationUpdateRequestDataAttributes getAttributes() {
    return attributes;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(@jakarta.annotation.Nullable AgeRatingDeclarationUpdateRequestDataAttributes attributes) {
    this.attributes = attributes;
  }
