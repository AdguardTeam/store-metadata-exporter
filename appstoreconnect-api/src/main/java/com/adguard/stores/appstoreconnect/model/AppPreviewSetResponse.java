...
public class AppPreviewSetResponse {
  ...
  public AppPreviewSetResponse data(@jakarta.annotation.Nonnull AppPreviewSet data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AppPreviewSet data) {
    this.data = data;
  }


  public AppPreviewSetResponse included(@jakarta.annotation.Nullable List<AppPreviewSetsResponseIncludedInner> included) {
  ...
  public AppPreviewSetResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
