...
public class AppEventScreenshotsResponse {
  ...
  public AppEventScreenshotsResponse data(@jakarta.annotation.Nonnull List<AppEventScreenshot> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<AppEventScreenshot> data) {
    this.data = data;
  }


  public AppEventScreenshotsResponse included(@jakarta.annotation.Nullable List<AppEventLocalization> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<AppEventLocalization> included) {
    this.included = included;
  }


  public AppEventScreenshotsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppEventScreenshotsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
