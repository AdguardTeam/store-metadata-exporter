...
public class BundleIdRelationshipsBundleIdCapabilities {
  ...
  public BundleIdRelationshipsBundleIdCapabilities links(@jakarta.annotation.Nullable RelationshipLinks links) {
    this.links = links;
    return this;
  }
  ...
  public BundleIdRelationshipsBundleIdCapabilities meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
  ...
  public BundleIdRelationshipsBundleIdCapabilities data(@jakarta.annotation.Nullable List<BundleIdRelationshipsBundleIdCapabilitiesDataInner> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable List<BundleIdRelationshipsBundleIdCapabilitiesDataInner> data) {
    this.data = data;
  }
