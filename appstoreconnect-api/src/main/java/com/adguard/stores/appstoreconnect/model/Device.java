...
public class Device {
  ...
  public Device type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public Device id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public Device attributes(@jakarta.annotation.Nullable DeviceAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(@jakarta.annotation.Nullable DeviceAttributes attributes) {
    this.attributes = attributes;
  }


  public Device links(@jakarta.annotation.Nullable ResourceLinks links) {
    this.links = links;
    return this;
  }
