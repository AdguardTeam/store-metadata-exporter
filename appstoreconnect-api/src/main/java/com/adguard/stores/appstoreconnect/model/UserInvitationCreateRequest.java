...
import com.adguard.stores.appstoreconnect.model.UserInvitationCreateRequestData;
...
public class UserInvitationCreateRequest {
  ...
  public UserInvitationCreateRequest data(@jakarta.annotation.Nonnull UserInvitationCreateRequestData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull UserInvitationCreateRequestData data) {
    this.data = data;
  }
