...
public class AppRelationshipsInAppPurchasesV2 {
  ...
  public AppRelationshipsInAppPurchasesV2 links(@jakarta.annotation.Nullable RelationshipLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppRelationshipsInAppPurchasesV2 meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
  ...
  public AppRelationshipsInAppPurchasesV2 data(@jakarta.annotation.Nullable List<AppRelationshipsInAppPurchasesDataInner> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable List<AppRelationshipsInAppPurchasesDataInner> data) {
    this.data = data;
  }
