...
public class CiArtifactResponse {
  ...
  public CiArtifactResponse data(@jakarta.annotation.Nonnull CiArtifact data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull CiArtifact data) {
    this.data = data;
  }


  public CiArtifactResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
