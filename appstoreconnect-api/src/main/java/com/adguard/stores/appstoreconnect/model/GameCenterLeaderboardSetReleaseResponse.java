...
public class GameCenterLeaderboardSetReleaseResponse {
  ...
  public GameCenterLeaderboardSetReleaseResponse data(@jakarta.annotation.Nonnull GameCenterLeaderboardSetRelease data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull GameCenterLeaderboardSetRelease data) {
    this.data = data;
  }


  public GameCenterLeaderboardSetReleaseResponse included(@jakarta.annotation.Nullable List<GameCenterLeaderboardSetReleasesResponseIncludedInner> included) {
  ...
  public GameCenterLeaderboardSetReleaseResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
