...
import com.adguard.stores.appstoreconnect.model.AppScreenshotCreateRequestDataRelationships;
...
public class AppScreenshotCreateRequestData {
  ...
  public AppScreenshotCreateRequestData type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AppScreenshotCreateRequestData attributes(@jakarta.annotation.Nonnull AppClipAdvancedExperienceImageCreateRequestDataAttributes attributes) {
  ...
  public AppScreenshotCreateRequestData relationships(@jakarta.annotation.Nonnull AppScreenshotCreateRequestDataRelationships relationships) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RELATIONSHIPS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRelationships(@jakarta.annotation.Nonnull AppScreenshotCreateRequestDataRelationships relationships) {
    this.relationships = relationships;
  }
