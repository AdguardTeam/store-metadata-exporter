...
public class SubscriptionOfferCodeResponse {
  ...
  public SubscriptionOfferCodeResponse data(@jakarta.annotation.Nonnull SubscriptionOfferCode data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull SubscriptionOfferCode data) {
    this.data = data;
  }


  public SubscriptionOfferCodeResponse included(@jakarta.annotation.Nullable List<SubscriptionOfferCodesResponseIncludedInner> included) {
  ...
  public SubscriptionOfferCodeResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
