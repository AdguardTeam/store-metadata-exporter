...
import com.adguard.stores.appstoreconnect.model.GameCenterLeaderboardSetMemberLocalizationAttributes;
import com.adguard.stores.appstoreconnect.model.GameCenterLeaderboardSetMemberLocalizationRelationships;
...
public class GameCenterLeaderboardSetMemberLocalization {
  ...
  public GameCenterLeaderboardSetMemberLocalization type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public GameCenterLeaderboardSetMemberLocalization id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public GameCenterLeaderboardSetMemberLocalization attributes(@jakarta.annotation.Nullable GameCenterLeaderboardSetMemberLocalizationAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(@jakarta.annotation.Nullable GameCenterLeaderboardSetMemberLocalizationAttributes attributes) {
    this.attributes = attributes;
  }


  public GameCenterLeaderboardSetMemberLocalization relationships(@jakarta.annotation.Nullable GameCenterLeaderboardSetMemberLocalizationRelationships relationships) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RELATIONSHIPS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationships(@jakarta.annotation.Nullable GameCenterLeaderboardSetMemberLocalizationRelationships relationships) {
    this.relationships = relationships;
  }


  public GameCenterLeaderboardSetMemberLocalization links(@jakarta.annotation.Nullable ResourceLinks links) {
    this.links = links;
    return this;
  }
