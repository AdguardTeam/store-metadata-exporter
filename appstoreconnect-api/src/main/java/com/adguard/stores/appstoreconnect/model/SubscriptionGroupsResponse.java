...
import com.adguard.stores.appstoreconnect.model.SubscriptionGroupsResponseIncludedInner;
...
public class SubscriptionGroupsResponse {
  ...
  public SubscriptionGroupsResponse data(@jakarta.annotation.Nonnull List<SubscriptionGroup> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<SubscriptionGroup> data) {
    this.data = data;
  }


  public SubscriptionGroupsResponse included(@jakarta.annotation.Nullable List<SubscriptionGroupsResponseIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<SubscriptionGroupsResponseIncludedInner> included) {
    this.included = included;
  }


  public SubscriptionGroupsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public SubscriptionGroupsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
