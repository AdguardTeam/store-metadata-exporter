...
public class AppCustomProductPageVersionResponse {
  ...
  public AppCustomProductPageVersionResponse data(@jakarta.annotation.Nonnull AppCustomProductPageVersion data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AppCustomProductPageVersion data) {
    this.data = data;
  }


  public AppCustomProductPageVersionResponse included(@jakarta.annotation.Nullable List<AppCustomProductPageVersionsResponseIncludedInner> included) {
  ...
  public AppCustomProductPageVersionResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
