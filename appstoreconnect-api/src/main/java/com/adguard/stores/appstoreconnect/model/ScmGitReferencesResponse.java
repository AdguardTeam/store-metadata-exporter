...
public class ScmGitReferencesResponse {
  ...
  public ScmGitReferencesResponse data(@jakarta.annotation.Nonnull List<ScmGitReference> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<ScmGitReference> data) {
    this.data = data;
  }


  public ScmGitReferencesResponse included(@jakarta.annotation.Nullable List<ScmRepository> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<ScmRepository> included) {
    this.included = included;
  }


  public ScmGitReferencesResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public ScmGitReferencesResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
