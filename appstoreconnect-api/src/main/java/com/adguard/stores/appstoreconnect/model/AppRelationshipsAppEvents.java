...
public class AppRelationshipsAppEvents {
  ...
  public AppRelationshipsAppEvents links(@jakarta.annotation.Nullable RelationshipLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppRelationshipsAppEvents meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
  ...
  public AppRelationshipsAppEvents data(@jakarta.annotation.Nullable List<AppEventLocalizationRelationshipsAppEventData> data) {
    this.data = data;
    return this;
  }
