...
import com.adguard.stores.appstoreconnect.model.AppCustomProductPageLocalizationsResponseIncludedInner;
...
public class AppCustomProductPageLocalizationsResponse {
  ...
  public AppCustomProductPageLocalizationsResponse data(@jakarta.annotation.Nonnull List<AppCustomProductPageLocalization> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<AppCustomProductPageLocalization> data) {
    this.data = data;
  }


  public AppCustomProductPageLocalizationsResponse included(@jakarta.annotation.Nullable List<AppCustomProductPageLocalizationsResponseIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<AppCustomProductPageLocalizationsResponseIncludedInner> included) {
    this.included = included;
  }


  public AppCustomProductPageLocalizationsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppCustomProductPageLocalizationsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
