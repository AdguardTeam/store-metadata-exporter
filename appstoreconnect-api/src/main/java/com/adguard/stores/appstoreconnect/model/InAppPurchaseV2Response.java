...
public class InAppPurchaseV2Response {
  ...
  public InAppPurchaseV2Response data(@jakarta.annotation.Nonnull InAppPurchaseV2 data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull InAppPurchaseV2 data) {
    this.data = data;
  }


  public InAppPurchaseV2Response included(@jakarta.annotation.Nullable List<InAppPurchasesV2ResponseIncludedInner> included) {
  ...
  public InAppPurchaseV2Response links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
