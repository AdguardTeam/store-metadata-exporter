...
import com.adguard.stores.appstoreconnect.model.UserAttributes;
...
public class User {
  ...
  public User type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public User attributes(@jakarta.annotation.Nullable UserAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(@jakarta.annotation.Nullable UserAttributes attributes) {
    this.attributes = attributes;
  }


  public User relationships(@jakarta.annotation.Nullable UserInvitationRelationships relationships) {
  ...
  public User links(@jakarta.annotation.Nullable ResourceLinks links) {
    this.links = links;
    return this;
  }
