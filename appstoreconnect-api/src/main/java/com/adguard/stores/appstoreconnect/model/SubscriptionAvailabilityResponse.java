...
public class SubscriptionAvailabilityResponse {
  ...
  public SubscriptionAvailabilityResponse data(@jakarta.annotation.Nonnull SubscriptionAvailability data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull SubscriptionAvailability data) {
    this.data = data;
  }


  public SubscriptionAvailabilityResponse included(@jakarta.annotation.Nullable List<Territory> included) {
    this.included = included;
    return this;
  }

  public SubscriptionAvailabilityResponse addIncludedItem(Territory includedItem) {
  ...
  public SubscriptionAvailabilityResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
