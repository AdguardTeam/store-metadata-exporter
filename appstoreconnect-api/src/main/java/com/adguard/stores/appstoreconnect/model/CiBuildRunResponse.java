...
public class CiBuildRunResponse {
  ...
  public CiBuildRunResponse data(@jakarta.annotation.Nonnull CiBuildRun data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull CiBuildRun data) {
    this.data = data;
  }


  public CiBuildRunResponse included(@jakarta.annotation.Nullable List<CiBuildRunsResponseIncludedInner> included) {
  ...
  public CiBuildRunResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
