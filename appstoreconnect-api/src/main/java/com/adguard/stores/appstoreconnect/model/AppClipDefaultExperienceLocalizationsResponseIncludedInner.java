...
import com.adguard.stores.appstoreconnect.model.AppClipAdvancedExperienceImageAttributes;
import com.adguard.stores.appstoreconnect.model.AppClipDefaultExperience;
import com.adguard.stores.appstoreconnect.model.AppClipHeaderImage;
import com.adguard.stores.appstoreconnect.model.AppClipHeaderImageRelationships;
...
public class AppClipDefaultExperienceLocalizationsResponseIncludedInner extends AbstractOpenApiSchema {
    ...
    public static class AppClipDefaultExperienceLocalizationsResponseIncludedInnerDeserializer extends StdDeserializer<AppClipDefaultExperienceLocalizationsResponseIncludedInner> {
        ...
        public AppClipDefaultExperienceLocalizationsResponseIncludedInner deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AppClipHeaderImage.class.equals(Integer.class) || AppClipHeaderImage.class.equals(Long.class) || AppClipHeaderImage.class.equals(Float.class) || AppClipHeaderImage.class.equals(Double.class) || AppClipHeaderImage.class.equals(Boolean.class) || AppClipHeaderImage.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AppClipHeaderImage.class.equals(Integer.class) || AppClipHeaderImage.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AppClipHeaderImage.class.equals(Float.class) || AppClipHeaderImage.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (AppClipHeaderImage.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AppClipHeaderImage.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            throw new IOException(String.format(Locale.ROOT, "Failed deserialization for AppClipDefaultExperienceLocalizationsResponseIncludedInner: %d classes match result, expected 1", match));
        }
   ...
   */
  @JsonAnySetter
  public AppClipDefaultExperienceLocalizationsResponseIncludedInner putAdditionalProperty(String key, Object value) {
  ...
  public Object getAdditionalProperty(String key) {
    ...
    /**
     * Return true if this AppClipDefaultExperienceLocalizationsResponse_included_inner object is equal to o.
     */
    @Override
    public boolean equals(Object o) {
        return super.equals(o) && Objects.equals(this.additionalProperties, ((AppClipDefaultExperienceLocalizationsResponseIncludedInner)o).additionalProperties);
    }
    ...
    static {
        ...
        schemas.put("AppClipHeaderImage", AppClipHeaderImage.class);
        ...
        mappings.put("appClipHeaderImages", AppClipHeaderImage.class);
        mappings.put("AppClipDefaultExperienceLocalizationsResponse_included_inner", AppClipDefaultExperienceLocalizationsResponseIncludedInner.class);
        JSON.registerDiscriminator(AppClipDefaultExperienceLocalizationsResponseIncludedInner.class, "type", mappings);
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(AppClipHeaderImage.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof AppClipDefaultExperience) {
        if (getActualInstance() != null) {
          joiner.add(((AppClipDefaultExperience)getActualInstance()).toUrlQueryString(prefix + "one_of_0" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AppClipHeaderImage) {
        if (getActualInstance() != null) {
          joiner.add(((AppClipHeaderImage)getActualInstance()).toUrlQueryString(prefix + "one_of_1" + suffix));
        }
        return joiner.toString();
    }
    return null;
