...
public class AppScreenshotResponse {
  ...
  public AppScreenshotResponse data(@jakarta.annotation.Nonnull AppScreenshot data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AppScreenshot data) {
    this.data = data;
  }


  public AppScreenshotResponse included(@jakarta.annotation.Nullable List<AppScreenshotSet> included) {
  ...
  public AppScreenshotResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
