...
import com.adguard.stores.appstoreconnect.model.AppScreenshotSetsResponseIncludedInner;
...
public class AppScreenshotSetsResponse {
  ...
  public AppScreenshotSetsResponse data(@jakarta.annotation.Nonnull List<AppScreenshotSet> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<AppScreenshotSet> data) {
    this.data = data;
  }


  public AppScreenshotSetsResponse included(@jakarta.annotation.Nullable List<AppScreenshotSetsResponseIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<AppScreenshotSetsResponseIncludedInner> included) {
    this.included = included;
  }


  public AppScreenshotSetsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppScreenshotSetsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
