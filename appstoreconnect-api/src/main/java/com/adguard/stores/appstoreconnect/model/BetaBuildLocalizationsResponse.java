...
public class BetaBuildLocalizationsResponse {
  ...
  public BetaBuildLocalizationsResponse data(@jakarta.annotation.Nonnull List<BetaBuildLocalization> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<BetaBuildLocalization> data) {
    this.data = data;
  }


  public BetaBuildLocalizationsResponse included(@jakarta.annotation.Nullable List<Build> included) {
  ...
  public BetaBuildLocalizationsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public BetaBuildLocalizationsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
