...
import com.adguard.stores.appstoreconnect.model.GameCenterMatchmakingRuleSetTestCreateRequestData;
import com.adguard.stores.appstoreconnect.model.GameCenterMatchmakingRuleSetTestCreateRequestIncludedInner;
...
public class GameCenterMatchmakingRuleSetTestCreateRequest {
  ...
  public GameCenterMatchmakingRuleSetTestCreateRequest data(@jakarta.annotation.Nonnull GameCenterMatchmakingRuleSetTestCreateRequestData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull GameCenterMatchmakingRuleSetTestCreateRequestData data) {
    this.data = data;
  }


  public GameCenterMatchmakingRuleSetTestCreateRequest included(@jakarta.annotation.Nullable List<GameCenterMatchmakingRuleSetTestCreateRequestIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<GameCenterMatchmakingRuleSetTestCreateRequestIncludedInner> included) {
    this.included = included;
  }
