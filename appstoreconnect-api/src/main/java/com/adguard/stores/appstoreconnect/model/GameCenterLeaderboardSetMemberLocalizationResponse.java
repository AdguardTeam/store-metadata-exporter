...
public class GameCenterLeaderboardSetMemberLocalizationResponse {
  ...
  public GameCenterLeaderboardSetMemberLocalizationResponse data(@jakarta.annotation.Nonnull GameCenterLeaderboardSetMemberLocalization data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull GameCenterLeaderboardSetMemberLocalization data) {
    this.data = data;
  }


  public GameCenterLeaderboardSetMemberLocalizationResponse included(@jakarta.annotation.Nullable List<GameCenterLeaderboardSetMemberLocalizationsResponseIncludedInner> included) {
  ...
  public GameCenterLeaderboardSetMemberLocalizationResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
