...
import com.adguard.stores.appstoreconnect.model.BetaAppReviewSubmissionCreateRequestData;
...
public class BetaAppReviewSubmissionCreateRequest {
  ...
  public BetaAppReviewSubmissionCreateRequest data(@jakarta.annotation.Nonnull BetaAppReviewSubmissionCreateRequestData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull BetaAppReviewSubmissionCreateRequestData data) {
    this.data = data;
  }
