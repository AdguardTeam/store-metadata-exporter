...
import com.adguard.stores.appstoreconnect.model.GameCenterEnabledVersionsResponseIncludedInner;
...
public class GameCenterEnabledVersionsResponse {
  ...
  public GameCenterEnabledVersionsResponse data(@jakarta.annotation.Nonnull List<GameCenterEnabledVersion> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<GameCenterEnabledVersion> data) {
    this.data = data;
  }


  public GameCenterEnabledVersionsResponse included(@jakarta.annotation.Nullable List<GameCenterEnabledVersionsResponseIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<GameCenterEnabledVersionsResponseIncludedInner> included) {
    this.included = included;
  }


  public GameCenterEnabledVersionsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public GameCenterEnabledVersionsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
