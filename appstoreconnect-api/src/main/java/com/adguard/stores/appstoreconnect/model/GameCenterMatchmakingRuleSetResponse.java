...
public class GameCenterMatchmakingRuleSetResponse {
  ...
  public GameCenterMatchmakingRuleSetResponse data(@jakarta.annotation.Nonnull GameCenterMatchmakingRuleSet data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull GameCenterMatchmakingRuleSet data) {
    this.data = data;
  }


  public GameCenterMatchmakingRuleSetResponse included(@jakarta.annotation.Nullable List<GameCenterMatchmakingRuleSetsResponseIncludedInner> included) {
  ...
  public GameCenterMatchmakingRuleSetResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
