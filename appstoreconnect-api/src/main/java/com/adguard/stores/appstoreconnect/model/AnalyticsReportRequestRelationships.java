...
import com.adguard.stores.appstoreconnect.model.AnalyticsReportRequestRelationshipsReports;
...
public class AnalyticsReportRequestRelationships {
  ...
  public AnalyticsReportRequestRelationships reports(@jakarta.annotation.Nullable AnalyticsReportRequestRelationshipsReports reports) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REPORTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReports(@jakarta.annotation.Nullable AnalyticsReportRequestRelationshipsReports reports) {
    this.reports = reports;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getReports() != null) {
      joiner.add(getReports().toUrlQueryString(prefix + "reports" + suffix));
    }
