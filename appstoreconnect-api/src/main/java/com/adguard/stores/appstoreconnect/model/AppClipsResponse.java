...
public class AppClipsResponse {
  ...
  public AppClipsResponse data(@jakarta.annotation.Nonnull List<AppClip> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<AppClip> data) {
    this.data = data;
  }


  public AppClipsResponse included(@jakarta.annotation.Nullable List<AppClipsResponseIncludedInner> included) {
  ...
  public AppClipsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppClipsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
