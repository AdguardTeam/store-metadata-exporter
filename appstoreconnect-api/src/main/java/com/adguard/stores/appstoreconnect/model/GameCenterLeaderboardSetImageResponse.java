...
public class GameCenterLeaderboardSetImageResponse {
  ...
  public GameCenterLeaderboardSetImageResponse data(@jakarta.annotation.Nonnull GameCenterLeaderboardSetImage data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull GameCenterLeaderboardSetImage data) {
    this.data = data;
  }


  public GameCenterLeaderboardSetImageResponse included(@jakarta.annotation.Nullable List<GameCenterLeaderboardSetLocalization> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<GameCenterLeaderboardSetLocalization> included) {
    this.included = included;
  }


  public GameCenterLeaderboardSetImageResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
