...
import com.adguard.stores.appstoreconnect.model.GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPointsValues;
...
public class GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPoints {
  ...
  public GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPoints start(@jakarta.annotation.Nullable OffsetDateTime start) {
    this.start = start;
    return this;
  }
  ...
  public GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPoints end(@jakarta.annotation.Nullable OffsetDateTime end) {
    this.end = end;
    return this;
  }
  ...
  public GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPoints values(@jakarta.annotation.Nullable GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPointsValues values) {
    this.values = values;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable GameCenterMatchmakingBooleanRuleResultsV1MetricResponseDataInnerDataPointsValues values) {
    this.values = values;
  }
