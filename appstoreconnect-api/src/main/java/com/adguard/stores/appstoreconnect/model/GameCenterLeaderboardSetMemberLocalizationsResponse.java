...
import com.adguard.stores.appstoreconnect.model.GameCenterLeaderboardSetMemberLocalization;
import com.adguard.stores.appstoreconnect.model.GameCenterLeaderboardSetMemberLocalizationsResponseIncludedInner;
...
public class GameCenterLeaderboardSetMemberLocalizationsResponse {
  ...
  public GameCenterLeaderboardSetMemberLocalizationsResponse data(@jakarta.annotation.Nonnull List<GameCenterLeaderboardSetMemberLocalization> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<GameCenterLeaderboardSetMemberLocalization> data) {
    this.data = data;
  }


  public GameCenterLeaderboardSetMemberLocalizationsResponse included(@jakarta.annotation.Nullable List<GameCenterLeaderboardSetMemberLocalizationsResponseIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<GameCenterLeaderboardSetMemberLocalizationsResponseIncludedInner> included) {
    this.included = included;
  }


  public GameCenterLeaderboardSetMemberLocalizationsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public GameCenterLeaderboardSetMemberLocalizationsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
