...
public class AppCustomProductPageLocalizationResponse {
  ...
  public AppCustomProductPageLocalizationResponse data(@jakarta.annotation.Nonnull AppCustomProductPageLocalization data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AppCustomProductPageLocalization data) {
    this.data = data;
  }


  public AppCustomProductPageLocalizationResponse included(@jakarta.annotation.Nullable List<AppCustomProductPageLocalizationsResponseIncludedInner> included) {
  ...
  public AppCustomProductPageLocalizationResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
