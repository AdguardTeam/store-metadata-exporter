...
public class BetaAppReviewSubmissionResponse {
  ...
  public BetaAppReviewSubmissionResponse data(@jakarta.annotation.Nonnull BetaAppReviewSubmission data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull BetaAppReviewSubmission data) {
    this.data = data;
  }


  public BetaAppReviewSubmissionResponse included(@jakarta.annotation.Nullable List<Build> included) {
  ...
  public BetaAppReviewSubmissionResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
