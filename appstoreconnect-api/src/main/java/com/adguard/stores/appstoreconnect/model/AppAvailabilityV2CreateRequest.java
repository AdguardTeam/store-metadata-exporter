...
import com.adguard.stores.appstoreconnect.model.AppAvailabilityV2CreateRequestData;
import com.adguard.stores.appstoreconnect.model.TerritoryAvailabilityInlineCreate;
...
public class AppAvailabilityV2CreateRequest {
  ...
  public AppAvailabilityV2CreateRequest data(@jakarta.annotation.Nonnull AppAvailabilityV2CreateRequestData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AppAvailabilityV2CreateRequestData data) {
    this.data = data;
  }


  public AppAvailabilityV2CreateRequest included(@jakarta.annotation.Nullable List<TerritoryAvailabilityInlineCreate> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<TerritoryAvailabilityInlineCreate> included) {
    this.included = included;
  }
