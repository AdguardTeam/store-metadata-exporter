...
public class SubscriptionUpdateRequestDataRelationshipsIntroductoryOffers {
  ...
  public SubscriptionUpdateRequestDataRelationshipsIntroductoryOffers data(@jakarta.annotation.Nullable List<SubscriptionRelationshipsIntroductoryOffersDataInner> data) {
    this.data = data;
    return this;
  }
