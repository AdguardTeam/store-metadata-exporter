...
import com.adguard.stores.appstoreconnect.model.AppPreviewRelationshipsAppPreviewSet;
...
public class AppPreviewRelationships {
  ...
  public AppPreviewRelationships appPreviewSet(@jakarta.annotation.Nullable AppPreviewRelationshipsAppPreviewSet appPreviewSet) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_APP_PREVIEW_SET, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_APP_PREVIEW_SET, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAppPreviewSet(@jakarta.annotation.Nullable AppPreviewRelationshipsAppPreviewSet appPreviewSet) {
    this.appPreviewSet = appPreviewSet;
  }
