...
import com.adguard.stores.appstoreconnect.model.ReviewSubmissionItemsResponseIncludedInner;
...
public class ReviewSubmissionItemsResponse {
  ...
  public ReviewSubmissionItemsResponse data(@jakarta.annotation.Nonnull List<ReviewSubmissionItem> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<ReviewSubmissionItem> data) {
    this.data = data;
  }


  public ReviewSubmissionItemsResponse included(@jakarta.annotation.Nullable List<ReviewSubmissionItemsResponseIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<ReviewSubmissionItemsResponseIncludedInner> included) {
    this.included = included;
  }


  public ReviewSubmissionItemsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public ReviewSubmissionItemsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
