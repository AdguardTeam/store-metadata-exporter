...
import com.adguard.stores.appstoreconnect.model.AppStoreVersionPhasedReleaseUpdateRequestData;
...
public class AppStoreVersionPhasedReleaseUpdateRequest {
  ...
  public AppStoreVersionPhasedReleaseUpdateRequest data(@jakarta.annotation.Nonnull AppStoreVersionPhasedReleaseUpdateRequestData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AppStoreVersionPhasedReleaseUpdateRequestData data) {
    this.data = data;
  }
