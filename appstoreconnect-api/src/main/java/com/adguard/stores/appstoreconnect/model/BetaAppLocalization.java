...
import com.adguard.stores.appstoreconnect.model.BetaAppLocalizationAttributes;
...
public class BetaAppLocalization {
  ...
  public enum TypeEnum {
    BETA_APP_LOCALIZATIONS(String.valueOf("betaAppLocalizations"));
  ...
  public BetaAppLocalization type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public BetaAppLocalization id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public BetaAppLocalization attributes(@jakarta.annotation.Nullable BetaAppLocalizationAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(@jakarta.annotation.Nullable BetaAppLocalizationAttributes attributes) {
    this.attributes = attributes;
  }


  public BetaAppLocalization relationships(@jakarta.annotation.Nullable BetaAppLocalizationRelationships relationships) {
  ...
  public BetaAppLocalization links(@jakarta.annotation.Nullable ResourceLinks links) {
    this.links = links;
    return this;
  }
