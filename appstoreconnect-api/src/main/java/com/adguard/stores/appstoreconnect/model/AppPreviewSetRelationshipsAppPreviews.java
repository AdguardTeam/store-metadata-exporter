...
public class AppPreviewSetRelationshipsAppPreviews {
  ...
  public AppPreviewSetRelationshipsAppPreviews links(@jakarta.annotation.Nullable RelationshipLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppPreviewSetRelationshipsAppPreviews meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
  ...
  public AppPreviewSetRelationshipsAppPreviews data(@jakarta.annotation.Nullable List<AppPreviewSetRelationshipsAppPreviewsDataInner> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable List<AppPreviewSetRelationshipsAppPreviewsDataInner> data) {
    this.data = data;
  }
