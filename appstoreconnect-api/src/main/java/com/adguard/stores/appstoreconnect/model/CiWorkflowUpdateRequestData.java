...
import com.adguard.stores.appstoreconnect.model.CiWorkflowUpdateRequestDataAttributes;
import com.adguard.stores.appstoreconnect.model.CiWorkflowUpdateRequestDataRelationships;
...
public class CiWorkflowUpdateRequestData {
  ...
  public CiWorkflowUpdateRequestData type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CiWorkflowUpdateRequestData id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public CiWorkflowUpdateRequestData attributes(@jakarta.annotation.Nullable CiWorkflowUpdateRequestDataAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(@jakarta.annotation.Nullable CiWorkflowUpdateRequestDataAttributes attributes) {
    this.attributes = attributes;
  }


  public CiWorkflowUpdateRequestData relationships(@jakarta.annotation.Nullable CiWorkflowUpdateRequestDataRelationships relationships) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RELATIONSHIPS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationships(@jakarta.annotation.Nullable CiWorkflowUpdateRequestDataRelationships relationships) {
    this.relationships = relationships;
  }
