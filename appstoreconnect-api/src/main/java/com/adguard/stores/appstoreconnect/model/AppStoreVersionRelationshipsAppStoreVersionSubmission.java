...
public class AppStoreVersionRelationshipsAppStoreVersionSubmission {
  ...
  public AppStoreVersionRelationshipsAppStoreVersionSubmission links(@jakarta.annotation.Nullable RelationshipLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppStoreVersionRelationshipsAppStoreVersionSubmission data(@jakarta.annotation.Nullable AppStoreVersionRelationshipsAppStoreVersionSubmissionData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable AppStoreVersionRelationshipsAppStoreVersionSubmissionData data) {
    this.data = data;
  }
