...
public class AppEncryptionDeclarationResponse {
  ...
  public AppEncryptionDeclarationResponse data(@jakarta.annotation.Nonnull AppEncryptionDeclaration data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AppEncryptionDeclaration data) {
    this.data = data;
  }


  public AppEncryptionDeclarationResponse included(@jakarta.annotation.Nullable List<AppEncryptionDeclarationsResponseIncludedInner> included) {
  ...
  public AppEncryptionDeclarationResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
