...
import com.adguard.stores.appstoreconnect.model.ErrorResponseErrorsInner;
...
public class ErrorResponse {
  ...
  public ErrorResponse errors(@jakarta.annotation.Nullable List<ErrorResponseErrorsInner> errors) {
    this.errors = errors;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ERRORS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setErrors(@jakarta.annotation.Nullable List<ErrorResponseErrorsInner> errors) {
    this.errors = errors;
  }
