...
public class AppScreenshotSetAttributes {
  ...
  public AppScreenshotSetAttributes screenshotDisplayType(@jakarta.annotation.Nullable ScreenshotDisplayType screenshotDisplayType) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SCREENSHOT_DISPLAY_TYPE, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_SCREENSHOT_DISPLAY_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setScreenshotDisplayType(@jakarta.annotation.Nullable ScreenshotDisplayType screenshotDisplayType) {
    this.screenshotDisplayType = screenshotDisplayType;
  }
