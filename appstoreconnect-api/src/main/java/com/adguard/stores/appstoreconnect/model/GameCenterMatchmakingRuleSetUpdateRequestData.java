...
import com.adguard.stores.appstoreconnect.model.GameCenterMatchmakingRuleSetUpdateRequestDataAttributes;
...
public class GameCenterMatchmakingRuleSetUpdateRequestData {
  ...
  public GameCenterMatchmakingRuleSetUpdateRequestData type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public GameCenterMatchmakingRuleSetUpdateRequestData id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public GameCenterMatchmakingRuleSetUpdateRequestData attributes(@jakarta.annotation.Nullable GameCenterMatchmakingRuleSetUpdateRequestDataAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(@jakarta.annotation.Nullable GameCenterMatchmakingRuleSetUpdateRequestDataAttributes attributes) {
    this.attributes = attributes;
  }
