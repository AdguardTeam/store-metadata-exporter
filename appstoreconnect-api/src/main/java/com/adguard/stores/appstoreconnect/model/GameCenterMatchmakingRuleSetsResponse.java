...
import com.adguard.stores.appstoreconnect.model.GameCenterMatchmakingRuleSet;
import com.adguard.stores.appstoreconnect.model.GameCenterMatchmakingRuleSetsResponseIncludedInner;
...
public class GameCenterMatchmakingRuleSetsResponse {
  ...
  public GameCenterMatchmakingRuleSetsResponse data(@jakarta.annotation.Nonnull List<GameCenterMatchmakingRuleSet> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<GameCenterMatchmakingRuleSet> data) {
    this.data = data;
  }


  public GameCenterMatchmakingRuleSetsResponse included(@jakarta.annotation.Nullable List<GameCenterMatchmakingRuleSetsResponseIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<GameCenterMatchmakingRuleSetsResponseIncludedInner> included) {
    this.included = included;
  }


  public GameCenterMatchmakingRuleSetsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public GameCenterMatchmakingRuleSetsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
