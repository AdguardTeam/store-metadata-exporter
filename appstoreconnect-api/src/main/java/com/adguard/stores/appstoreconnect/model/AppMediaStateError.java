...
public class AppMediaStateError {
  ...
  public AppMediaStateError code(@jakarta.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public AppMediaStateError description(@jakarta.annotation.Nullable String description) {
