...
import com.adguard.stores.appstoreconnect.model.UserUpdateRequestData;
...
public class UserUpdateRequest {
  ...
  public UserUpdateRequest data(@jakarta.annotation.Nonnull UserUpdateRequestData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull UserUpdateRequestData data) {
    this.data = data;
  }
