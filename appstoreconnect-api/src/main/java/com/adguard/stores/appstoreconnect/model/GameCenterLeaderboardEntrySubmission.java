...
import com.adguard.stores.appstoreconnect.model.GameCenterLeaderboardEntrySubmissionAttributes;
...
public class GameCenterLeaderboardEntrySubmission {
  ...
  public enum TypeEnum {
    GAME_CENTER_LEADERBOARD_ENTRY_SUBMISSIONS(String.valueOf("gameCenterLeaderboardEntrySubmissions"));
  ...
  public GameCenterLeaderboardEntrySubmission type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public GameCenterLeaderboardEntrySubmission id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public GameCenterLeaderboardEntrySubmission attributes(@jakarta.annotation.Nullable GameCenterLeaderboardEntrySubmissionAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributes(@jakarta.annotation.Nullable GameCenterLeaderboardEntrySubmissionAttributes attributes) {
    this.attributes = attributes;
  }


  public GameCenterLeaderboardEntrySubmission links(@jakarta.annotation.Nullable ResourceLinks links) {
    this.links = links;
    return this;
  }
