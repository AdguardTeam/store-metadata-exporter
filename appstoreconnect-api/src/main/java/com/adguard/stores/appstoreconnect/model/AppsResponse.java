...
import com.adguard.stores.appstoreconnect.model.AppsResponseIncludedInner;
...
public class AppsResponse {
  ...
  public AppsResponse data(@jakarta.annotation.Nonnull List<App> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<App> data) {
    this.data = data;
  }


  public AppsResponse included(@jakarta.annotation.Nullable List<AppsResponseIncludedInner> included) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(@jakarta.annotation.Nullable List<AppsResponseIncludedInner> included) {
    this.included = included;
  }


  public AppsResponse links(@jakarta.annotation.Nonnull PagedDocumentLinks links) {
    this.links = links;
    return this;
  }
  ...
  public AppsResponse meta(@jakarta.annotation.Nullable PagingInformation meta) {
    this.meta = meta;
    return this;
  }
