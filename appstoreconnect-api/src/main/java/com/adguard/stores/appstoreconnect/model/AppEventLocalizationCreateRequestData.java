...
import com.adguard.stores.appstoreconnect.model.AppEventLocalizationCreateRequestDataAttributes;
import com.adguard.stores.appstoreconnect.model.AppEventLocalizationCreateRequestDataRelationships;
...
public class AppEventLocalizationCreateRequestData {
  ...
  public AppEventLocalizationCreateRequestData type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AppEventLocalizationCreateRequestData attributes(@jakarta.annotation.Nonnull AppEventLocalizationCreateRequestDataAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAttributes(@jakarta.annotation.Nonnull AppEventLocalizationCreateRequestDataAttributes attributes) {
    this.attributes = attributes;
  }


  public AppEventLocalizationCreateRequestData relationships(@jakarta.annotation.Nonnull AppEventLocalizationCreateRequestDataRelationships relationships) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RELATIONSHIPS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRelationships(@jakarta.annotation.Nonnull AppEventLocalizationCreateRequestDataRelationships relationships) {
    this.relationships = relationships;
  }
