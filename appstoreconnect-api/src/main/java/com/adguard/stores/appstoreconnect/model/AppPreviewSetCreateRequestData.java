...
import com.adguard.stores.appstoreconnect.model.AppPreviewSetCreateRequestDataAttributes;
...
public class AppPreviewSetCreateRequestData {
  ...
  public AppPreviewSetCreateRequestData type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AppPreviewSetCreateRequestData attributes(@jakarta.annotation.Nonnull AppPreviewSetCreateRequestDataAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAttributes(@jakarta.annotation.Nonnull AppPreviewSetCreateRequestDataAttributes attributes) {
    this.attributes = attributes;
  }


  public AppPreviewSetCreateRequestData relationships(@jakarta.annotation.Nullable AppPreviewSetCreateRequestDataRelationships relationships) {
