...
import com.adguard.stores.appstoreconnect.model.AppClipDefaultExperienceLocalizationRelationshipsAppClipHeaderImage;
...
public class AppClipDefaultExperienceLocalizationRelationships {
  ...
  public AppClipDefaultExperienceLocalizationRelationships appClipDefaultExperience(@jakarta.annotation.Nullable AppClipAppStoreReviewDetailRelationshipsAppClipDefaultExperience appClipDefaultExperience) {
  ...
  public AppClipDefaultExperienceLocalizationRelationships appClipHeaderImage(@jakarta.annotation.Nullable AppClipDefaultExperienceLocalizationRelationshipsAppClipHeaderImage appClipHeaderImage) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_APP_CLIP_HEADER_IMAGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_APP_CLIP_HEADER_IMAGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAppClipHeaderImage(@jakarta.annotation.Nullable AppClipDefaultExperienceLocalizationRelationshipsAppClipHeaderImage appClipHeaderImage) {
    this.appClipHeaderImage = appClipHeaderImage;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `appClipHeaderImage` to the URL query string
    if (getAppClipHeaderImage() != null) {
      joiner.add(getAppClipHeaderImage().toUrlQueryString(prefix + "appClipHeaderImage" + suffix));
    }
