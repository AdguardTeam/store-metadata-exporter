...
public class ScmGitReferenceResponse {
  ...
  public ScmGitReferenceResponse data(@jakarta.annotation.Nonnull ScmGitReference data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull ScmGitReference data) {
    this.data = data;
  }


  public ScmGitReferenceResponse included(@jakarta.annotation.Nullable List<ScmRepository> included) {
  ...
  public ScmGitReferenceResponse links(@jakarta.annotation.Nonnull DocumentLinks links) {
    this.links = links;
    return this;
  }
